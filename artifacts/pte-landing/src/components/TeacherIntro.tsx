...
const PINK = "#FF4DA6";
const PINK_TEXT = "#FF87C7";
const GOLD = "#FAC775";
const GRAY = "#a99cc0";

// Ambient floating particles — pink only (decorative)
const particles = [
  { left: "10%", top: "20%", size: 5, color: PINK, dur: 8, delay: 0 },
  { left: "44%", top: "82%", size: 4, color: PINK_TEXT, dur: 9, delay: 1.2 },
  { left: "62%", top: "16%", size: 5, color: PINK, dur: 7.5, delay: 0.6 },
  { left: "88%", top: "60%", size: 4, color: PINK_TEXT, dur: 10, delay: 1.8 },
  { left: "30%", top: "54%", size: 3, color: PINK, dur: 8.5, delay: 2.2 },
];
  ...
  return (
    <section id="about" className="py-24 bg-[#120A2E] relative overflow-hidden cyber-scanlines">
      ...
      <div className="absolute top-0 left-0 w-40 h-40 border-t-2 border-l-2 pointer-events-none"
        style={{ borderColor: "rgba(255,77,166,0.4)", boxShadow: "0 0 16px rgba(255,77,166,0.2)" }} />
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="absolute top-8 -left-8 w-full h-full rounded-[2rem] -z-10"
              style={{ background: "rgba(255,77,166,0.05)", border: "1px solid rgba(255,77,166,0.10)" }} />
            <div className="absolute -bottom-8 right-8 w-full h-full rounded-[2rem] -z-10"
              style={{ border: "1px solid rgba(255,135,199,0.18)" }} />
            ...
            <div className="relative w-full max-w-sm bg-slate-900/80 backdrop-blur-sm rounded-[2rem] shadow-2xl border border-primary/20 cyber-corner neon-border overflow-hidden">
              ...
              <div className="px-6 pb-6 pt-3 flex flex-col gap-4">
                ...
                <div className="text-center">
                  <h3 className="text-2xl font-extrabold text-white" style={{ textShadow: "0 0 24px rgba(255,77,166,0.4)" }}>
                    Cô Nguyễn Thị Thuỷ
                  </h3>
                ...
                <div className="flex flex-col items-center gap-2 pt-1">
                  <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium"
                    style={{ color: PINK_TEXT, background: "rgba(255,77,166,0.10)", border: "1px solid rgba(255,77,166,0.28)" }}>
                    🎓 Đại Học Hà Nội
                  </span>
                  <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium"
                    style={{ color: PINK_TEXT, background: "rgba(255,77,166,0.10)", border: "1px solid rgba(255,77,166,0.28)" }}>
            ...
            <div className="mb-10">
              ...
              <div className="flex items-center gap-3 mb-4">
                <motion.div className="h-[1px] w-8 rounded-full"
                  style={{ background: PINK, boxShadow: "0 0 6px rgba(255,77,166,0.8)" }}
                ...
                <motion.div className="h-[1px] flex-1 rounded-full"
                  style={{ background: "linear-gradient(90deg, rgba(255,77,166,0.4), transparent)" }}
              ...
              <h2 className="font-heading font-black leading-[0.95] mb-2" style={{ fontFamily: "'Outfit', sans-serif" }}>
                ...
                <motion.span
                  ...
                  style={{
                    ...
                    filter: "drop-shadow(0 0 24px rgba(255,77,166,0.5))",
                  }}
              ...
              <div className="mt-4 h-[2px] rounded-full w-3/4"
                style={{ background: `linear-gradient(90deg, ${PINK}, ${PINK_TEXT}, transparent)`, boxShadow: "0 0 8px rgba(255,77,166,0.4)" }} />
            </div>
