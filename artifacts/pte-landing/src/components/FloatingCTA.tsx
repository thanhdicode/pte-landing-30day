      ...
      <AnimatePresence>
        {visible && (
          <motion.button
            ...
            className="fixed bottom-6 right-6 z-50 flex items-center gap-2 px-5 py-3 rounded-full font-bold text-sm text-white group cursor-pointer"
            style={{
          ...
          >
            {/* Shimmer */}
            <motion.span className="absolute inset-0 rounded-full pointer-events-none overflow-hidden" aria-hidden>
              <motion.span
