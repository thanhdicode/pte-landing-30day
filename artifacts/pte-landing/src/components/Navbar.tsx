      ...
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          isScrolled || mobileOpen
            ? "bg-[#1C0B22]/90 backdrop-blur-md py-3 border-b border-primary/20"
            : "bg-transparent py-5"
        }`}
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="fixed top-[68px] left-0 right-0 z-40 bg-[#1C0B22]/95 backdrop-blur-md shadow-lg border-t border-primary/20 md:hidden cyber-grid-bg"
          >
