export function Purple() {
  const primary = "#BF5FFF";
  const secondary = "#FF4DA6";
  const scores = [
    { val: "24+", label: "BEGINNER", color: "#00FFFF" },
    { val: "50+", label: "INTERMEDIATE", color: "#BF5FFF" },
    { val: "65+", label: "UPPER-INT", color: "#FF4DA6" },
    { val: "79+", label: "ADVANCED", color: "#facc15" },
  ];
  return (
    <div style={{ minHeight: "100vh", background: "#070412", fontFamily: "'Plus Jakarta Sans', sans-serif", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "absolute", top: "10%", right: "15%", width: 420, height: 420, background: `${primary}30`, borderRadius: "50%", filter: "blur(80px)", pointerEvents: "none" }} />
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "60px 48px 40px", position: "relative", zIndex: 10 }}>
        <div style={{ maxWidth: 620 }}>
          ...
          <div style={{ fontSize: 32, fontWeight: 900, letterSpacing: 2, marginBottom: 32, background: `linear-gradient(90deg, ${secondary}, #f0abfc)`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
          ...
          <div style={{ display: "flex", gap: 16 }}>
            <button style={{ background: `linear-gradient(135deg, ${primary}, ${secondary})`, color: "#fff", border: "none", borderRadius: 50, padding: "14px 32px", fontWeight: 800, fontSize: 14, cursor: "pointer", boxShadow: `0 0 30px ${primary}88`, letterSpacing: 1 }}>⚡ ĐĂNG KÝ NGAY — MIỄN PHÍ TƯ VẤN →</button>
        ...
        <div style={{ width: 340, background: "#0d0520", borderRadius: 24, border: `1.5px solid ${primary}44`, boxShadow: `0 0 40px ${primary}33`, overflow: "hidden", flexShrink: 0 }}>
          ...
          <div style={{ padding: "0 20px 20px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
              {[["10 NĂM","GIẢNG DẠY"],["4 NĂM","PTE"],["500+","HỌC VIÊN"]].map(([v,l]) => (
                <div key={l} style={{ textAlign: "center", padding: "10px 4px", background: "#1a0a2e", borderRadius: 10, border: `1px solid ${primary}22` }}>
