export function Gold() {
  ...
  const scores = [
    ...
    { val: "50+", label: "INTERMEDIATE", color: "#FFD700" },
    { val: "65+", label: "UPPER-INT", color: "#fb923c" },
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#020617", fontFamily: "'Plus Jakarta Sans', sans-serif", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "absolute", top: "10%", right: "15%", width: 420, height: 420, background: `${primary}22`, borderRadius: "50%", filter: "blur(80px)", pointerEvents: "none" }} />
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "18px 48px", borderBottom: `1px solid ${primary}33`, position: "relative", zIndex: 10 }}>
        ...
        <button style={{ background: primary, color: "#020617", border: "none", borderRadius: 50, padding: "10px 24px", fontWeight: 800, fontSize: 14, cursor: "pointer", boxShadow: `0 0 20px ${primary}88` }}>Đăng ký học</button>
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "60px 48px 40px", position: "relative", zIndex: 10 }}>
        <div style={{ maxWidth: 620 }}>
          ...
          <div style={{ display: "flex", gap: 16 }}>
            <button style={{ background: primary, color: "#020617", border: "none", borderRadius: 50, padding: "14px 32px", fontWeight: 800, fontSize: 14, cursor: "pointer", boxShadow: `0 0 30px ${primary}88`, letterSpacing: 1 }}>⚡ ĐĂNG KÝ NGAY — MIỄN PHÍ TƯ VẤN →</button>
